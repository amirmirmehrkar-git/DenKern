...
# Archived Chat Note: Five Canonical Decision Scenarios

Source: Archived chat excerpt. These scenarios are presented as "enterprise-grade" disruption options for logistics managers.
...
Description: Change maritime route to avoid the affected area (e.g., Cape of Good Hope instead of Suez).
...
Description: Discharge at a different port (e.g., Rotterdam/Antwerp) and complete delivery via rail or truck.
...
Each scenario can be evaluated with the same columns:
